...
makeHaskell opts cf = do
  ...
  do
    ...
    mkfile (printerFile opts)  $ cf2Printer (byteStrings opts) (functor opts) False (positionsInAST opts) prMod absMod cf
        ...
        = let lay = hasLayout cf
          ...
          in unlines
                ["-- automatically generated by BNF Converter",
                 ...
                 if use_glr then runGlr else runStd use_xml (positionsInAST opts),
                 "",
